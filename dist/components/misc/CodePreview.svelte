...
<style>
	.code-preview {
		...
		.code-preview .logs pre {
				display: block;
			}

		.code-preview .logs .log:not(:only-child):not(:last-child) {
	...
	.footer-buttons .preview-width span {
				padding: 0.5rem;
				font-size: 0.75rem;
				border: 1px solid var(--color-gray-9);
				background: var(--color-gray-9);
			}
	.footer-buttons .preview-width span:first-child {
					padding-right: 0;
				}
	.footer-buttons .preview-width span:last-child {
					padding-left: 0.25rem;
				}
	.footer-buttons .preview-width .static-width:focus-visible {
					outline: none;
				}
	.footer-buttons .preview-width .static-width::-moz-selection {
					background: var(--color-gray-7);
				}
	.footer-buttons .preview-width .static-width::selection {
					background: var(--color-gray-7);
				}
	.footer-buttons .switch-view {
			flex: 1;
		}
	.footer-buttons .preview-orientation {
			font-size: 1.25rem;
			padding: 0.25rem 0.5rem;
		}
	.footer-buttons .auto-refresh {
			font-size: 1.5rem;
			padding: 0.25rem 0.5rem;
			opacity: 0.5;
		}
	.footer-buttons .auto-refresh.toggled {
				opacity: 1;
			}
