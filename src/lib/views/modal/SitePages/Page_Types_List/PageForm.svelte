<script>
	...
	export let new_page_name = ''
	export let new_color = '#2B407D'
	let new_page_color = ''
	export let new_icon = 'iconoir:page'
	$: page_creation_disabled = !new_page_name
...
>
	<div style="width: 100%">
		<div class="top" style="display: flex;gap: 0.5rem;">
			...
			<button
				use:popperRef
				on:click={() => (showing_icon_picker = true)}
				style="display: flex;
				align-items: center;
			...
			<div class="color">
				<label>
					...
					<span class="preview" style:background-color={new_color} />
				</label>
			</div>
